...
<head>
    ...
    <title>Bank Sampah Panguripan</title>
...
<body>
    ...
    <header id="header" class="fixed-top d-flex align-items-center header-transparent">
        <div class="container d-flex align-items-center justify-content-between">
            ...
            <div class="logo">
                <h1><a href="index.html"><span>Bank Sampah Panguripan</span></a></h1>
            ...
            <div class="row justify-content-between">
                <div class="col-lg-7 pt-5 pt-lg-0 order-2 order-lg-1 d-flex align-items-center">
                    <div data-aos="zoom-out">
                        <h1>Selamat datang di <span>Bank Sampah Panguripan</span></h1>
                        <h2>Menabung dari sampah bisa dapat rumah mewah yang penting jangan kecewah!</h2>
    ...
    <footer id="footer">
        ...
        <div class="container">
            <div class="copyright">
                &copy; Copyright <strong><span>Bank Sampah Panguripan</span></strong>. All Rights Reserved
            </div>
        </div>
    </footer><!-- End Footer -->
